...
class VideoCamera(object):
	...
	def get_frame(self):
		...
		# Custom Time attribute
		current_time = time.time()
		if not hasattr(self, 'last_capture_time') or (current_time - self.last_capture_time) >= 0:
			...
			for (x,y,w,h) in face_rects:
				...
				print("_____________PREDICTED EMOTION________", emotion_dict[show_text[0]])
